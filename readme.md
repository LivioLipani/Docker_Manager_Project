...
A web-based Docker management application that provides real-time monitoring and control of Docker containers, images, volumes, networks and compose through an intuitive dashboard interface.
